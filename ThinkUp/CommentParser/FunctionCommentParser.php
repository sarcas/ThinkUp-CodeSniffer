 ...
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
class ThinkUp_CommentParser_FunctionCommentParser
    extends PHP_CodeSniffer_CommentParser_FunctionCommentParser
{
     ...
     *
     * @var array(ThinkUp_CommentParser_ParameterElement)
     */
     ...
     *
     * @var ThinkUp_CommentParser_ReturnElement
     */
     ...
     *
     * @return ThinkUp_CommentParser_ParameterElement
     */
    protected function parseParam($tokens)
    {
        $param = new ThinkUp_CommentParser_ParameterElement(
     ...
     *
     * @return ThinkUp_CommentParser_ReturnElement
     */
    protected function parseReturn($tokens)
    {
        $return = new ThinkUp_CommentParser_ReturnElement(
            $this->previousElement,
            $tokens,
            'return',
            $this->phpcsFile
     ...
     *
     * @return array(ThinkUp_CommentParser_ParameterElement)
     */
