 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ThinkUp_Sniffs_Strings_UnnecessaryStringConcatSniff extends Generic_Sniffs_Strings_UnnecessaryStringConcatSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (in_array($tokens[$prev]['code'], $stringTokens) === true
            ...
            if ($tokens[$prev]['content'][0] === $tokens[$next]['content'][0]) {
                ...
                $lineLengthLimitSniff = new ThinkUp_Sniffs_Files_LineLengthSniff;
